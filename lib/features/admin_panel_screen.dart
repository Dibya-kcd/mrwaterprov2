...
class AdminPanelScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // ── No AppBar — close button lives inside the hero card ──
      body: SafeArea(
        child: SingleChildScrollView(
          padding: const EdgeInsets.fromLTRB(20, 20, 20, 32),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [

            // ── Hero / Welcome card (contains X + badge) ─────────────────────
            Container(
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(
                        owner ? Icons.verified_user_rounded : Icons.person_rounded,
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                  side: BorderSide(color: AppColors.dangerColor(isDark).withValues(alpha: 0.40)),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
                ),
              ),
            ),
            ...
            if (!owner) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                      color: AppColors.dangerColor(isDark).withValues(alpha: 0.22)),
                ),
                child: Row(children: [
  ...
  void _showResetOwnerPin(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Owner PIN reset will be available in the next update.',
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Access Logs',
            style: GoogleFonts.inter(fontWeight: FontWeight.w800)),
        content: Text('Log viewing will be available after integrating access-event storage.',
            style: GoogleFonts.inter(fontSize: 13, color: AppColors.inkMuted, height: 1.4)),
        actions: [
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Sign Out',
                style: GoogleFonts.inter(
                    color: AppColors.dangerColor(isDark), fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    ) ?? false;
